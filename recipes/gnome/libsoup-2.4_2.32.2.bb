...
DEPENDS_sifteam = "glib-2.0 gnutls libxml2 sqlite3"
...
SRC_URI_sifteam = "${GNOME_MIRROR}/libsoup/${@'.'.join((bb.data.getVar('PV', d, 1)).split('.')[:2])}/libsoup-${PV}.tar.bz2"
...
EXTRA_OECONF_sifteam += "--without-gnome"
