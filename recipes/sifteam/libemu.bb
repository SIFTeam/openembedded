...
CXXFLAGS_append = " -I${STAGING_INCDIR}/Sockets/ -I${STAGING_INCDIR}/python2.6/ -I${STAGING_INCDIR}/libxml2/ "
...
do_install() {
	...
	install -m 755 _libemu.so ${D}/${libdir}/python2.6/lib-dynload/
	install -m 644 src/libemu.py ${D}/${libdir}/python2.6/
}
