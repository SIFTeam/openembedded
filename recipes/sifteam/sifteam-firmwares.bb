DESCRIPTION = "virtual package for compile all firmwares"

RDEPENDS_${PN} = " \
	firmware-dvb-usb-digitv-02 \
	firmware-dvb-usb-ec168 \
	firmware-dvb-usb-megasky-02 \
	firmware-dvb-usb-digivox-02 \
	firmware-dvb-usb-tvwalkert \
	...
	firmware-dvb-siano \
	firmware-dvb-usb-nova-t-usb2-01 \
	firmware-dvb-usb-nova-t-usb2-02 \
	firmware-isdbt-nova-12mhz-b0 \
	firmware-sms1xxx-nova-a-dvbt-01 \
	firmware-sms1xxx-nova-b-dvbt-01 \
	firmware-dvb-usb-adstech-usb2-02 \
	firmware-dvb-usb-af9015 \
	firmware-dvb-usb-avertv-a800-02 \
